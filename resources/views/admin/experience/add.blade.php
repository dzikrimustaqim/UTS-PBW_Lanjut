                ...
                <form action="{{ url('/experience') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_pelatihan') is-invalid @enderror"
                            id="exampleInputEmail1" aria-describedby="emailHelp" name="nama_pelatihan">
                    ...
                    <div class="form mb-3">
                        ...
                        <select class="form-select @error('experiencecategory_id') is-invalid @enderror"
                            ...
                            <option selected>Experience Category</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('penyelenggara') is-invalid @enderror"
                            id="exampleInputEmail1" aria-describedby="emailHelp" name="penyelenggara">
                        @error('penyelenggara')
                            <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('waktu_pelaksanaan') is-invalid @enderror"
                            id="exampleInputEmail1" aria-describedby="emailHelp" name="waktu_pelaksanaan">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('tingkatan') is-invalid @enderror"
                            id="exampleInputEmail1" aria-describedby="emailHelp" name="tingkatan">
                        @error('tingkatan')
                            <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('deskripsi') is-invalid @enderror"
                            id="exampleInputEmail1" aria-describedby="emailHelp" name="deskripsi">
                        @error('deskripsi')
                            <div class="invalid-feedback">
